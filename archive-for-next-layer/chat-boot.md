...
**Current Game:**  
You play as an explorer in a procedurally generated dungeon, aiming to find and reach the exit door before being caught by an adversary. As you move, you leave behind a visible trail; the adversary also leaves its own trail. Both you and the adversary can see these trails when they are within your vision radius, but your view is limited by a Fog of War that restricts sight to your immediate surroundings. The adversary searches for and follows your trail, moving step by step from one adjacent trail tile to the next. If it loses the trail, it resumes exploring the dungeon until it finds it again. Occasionally, triggering a noise trap reveals your exact location to the adversary for a short time, making escape more urgent. Your health, speed, and vision radius are displayed in the HUD and can potentially be modified by future game features. The game ends when you escape through the door or are caught by the adversary, with each turn offering tense, strategic movement as you try to outwit your pursuer within the shifting confines of the dungeon.  
