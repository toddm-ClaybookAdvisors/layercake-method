<!--
  ...
  GENERATED BY: Layer 0029 (move chat, policy update: only update LAYER_INDEX.md on merge to main)
...
- **LAYER_INDEX.md update policy.**  
  **LAYER_INDEX.md is only to be updated when merging to `main`.** During normal development on feature, fix, or refactor branches, LAYER_INDEX.md is NOT updated. Update it only when merging new layers to `main`, with the latest commit hashes and prompt links.
...
- **Last layer:** 0029 — Refactor entity system for clarity, modularity, and hallway robustness  
- **Current layer:** 0029 — (chat move does *not* increment)  
