...
<!--
  ...
  GENERATED BY: Layer 0035 (move chat, maximum clarity pass, minor ambiguity fix)
...
This section is non-negotiable. If any ambiguity arises, enforce the strictest version of every rule.
...
This section is non-negotiable. All context, code, and artifact policies are strictly enforced.
...
- **Last layer:** 0035 — Maximum clarity pass (all ambiguity and contradiction removed)  
- **Current layer:** 0035 — (move chat, minor fixes, does not increment layer number)  
...
**This version eliminates all ambiguity, explicitly qualifies every “no summaries/code/outputs” rule as applying only to devlogs, and clarifies “bottom-of-file” ordering for templates.**  
If you want this as a ready-to-commit file or need further tightening, just say the word!
```
